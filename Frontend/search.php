                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                    <a class="breadcrumb-item" style="font-size: 2rem; font-weight:800" href="index.html">Searched</a>
                                    <span  class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>

                                    <?php
                                       $search = $_POST['search'];
                                       ?>
                                       <span style="font-size: 2rem; font-weight:800" class="breadcrumb-item active"><?= $search?></span>
                                            ...
                                            <div class="category">
                                                <div class="ht__cat__thumb">
                                                    ...
                                                    if($cat_item['image_name']==""){
                                                        ...
                                                        ?>
                                                         <img style="aspect-ratio: 1/1; width:290px; height:350px;" src="<?="../images/food/".$cat_item['image_name'] ?>" alt="product images">
                                                ...
                                                <div class="fr__product__inner">
                                                    ...
                                                    <ul class="fr__pro__prize">
                                                        <li class="old__prize">RS<?=$cat_item['price'] ?></li>
